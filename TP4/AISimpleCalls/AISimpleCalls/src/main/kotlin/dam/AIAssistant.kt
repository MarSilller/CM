...
interface AIAssistant {
     ...
     * Evaluates the sentiment on a 7-point scale and returns a JSON object.
     *
     * @param input The raw user input to analyze
    ...
    suspend fun processSentimentAnalysis(input: String): String {
        val prompt = """
            ...
            The answer MUST be ONLY in the following valid JSON format without markdown blocks:
            {
                "rating": value,
                "justification": "value"
            }
